...
class IVSumTest {
    ...
    @Test
    void test4() {
        assertThat(obj.fourSum(new int[]{-1,0,1,2,-1,-4},
                -1)).isEqualTo(List.of(
                        List.of(-4,0,1,2),
                List.of(-1,-1,0,1)
        ));
    ...
    @Test
    void test5() {
        assertThat(obj.fourSum(new int[]{0,0,0,1000000000,1000000000,1000000000,1000000000},
                1000000000)).isEqualTo(List.of(
